...
void geom(line GeomInput i[2], inout TriangleStream<FragInputTile> stream) {
	...
	if (I.slot > _VisibleSlotCount)
		return;

	o.uv = 0;
	if (I.slot < 0.0 || I.slot > _VisibleSlotCount)
		return; // no Append() happens at all
